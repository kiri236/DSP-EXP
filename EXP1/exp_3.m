...
n1 = n .* (t1 >= -T0) .* (t1 <= T0);
r1 = (t1 >= -T0) .* (t1 <= T0);
x_11 = exp(1i*2*pi*f1*t1)+exp(1i*2*pi*f2*t1).*r1;%%delta(f-f1)+delta(f-f2)
...
x_12 = exp(1i*2*pi*f1*t1)+exp(1i*2*pi*f2*t1).*r2;%%delta(f-f1)+delta(f-f2)
